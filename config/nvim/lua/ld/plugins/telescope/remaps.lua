...
nnoremap('<leader>vs', "<cmd>lua require('ld.plugins.telescope.functions').search_config()<CR>", 'telescope', 'telescope_search_config', 'Search neovim config')
nnoremap('<leader>vch', "<cmd>lua require('telescope.builtin').command_history()<CR>", 'telescope', 'telescope_command_history', 'Search command history')
nnoremap('<leader>vcl', "<cmd>lua require('telescope.builtin').commands()<CR>", 'telescope', 'telescope_commands', 'Search commands')
nnoremap('<leader>vr', "<cmd>lua require('telescope.builtin').registers()<CR>", 'telescope', 'telescope_registers', 'Search registers')
nnoremap('<leader>vk', "<cmd>lua require('telescope.builtin').keymaps()<CR>", 'telescope', 'telescope_keymaps', 'Search keymaps')

nnoremap('<leader>bf', "<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>", 'telescope', 'telescope_current_buffer_fuzzy_find', 'Search current buffer')
