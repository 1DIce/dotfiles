...
nnoremap("<leader>fl", "<cmd>lua require('ld.plugins.telescope.functions').live_grep_raw()<CR>", "Live grep")
vnoremap(
	"<leader>fl",
...
nnoremap("<leader>vs", "<cmd>lua require('ld.plugins.telescope.functions').search_config()<CR>", "Search neovim config")
nnoremap("<leader>vh", "<cmd>lua require('telescope.builtin').help_tags()<CR>", "Search vim help tags")
nnoremap("<leader>vch", "<cmd>lua require('telescope.builtin').command_history()<CR>", "Search command history")
...
nnoremap("<leader>bf", "<cmd>lua require('telescope.builtin').current_buffer_fuzzy_find()<CR>", "Search current buffer")

nnoremap("<leader>bc", "<cmd>lua require('telescope.builtin').git_bcommits()<CR>", "Search buffer git commits")

nnoremap("<leader>bl", "<cmd>lua require('ld.plugins.telescope.functions').buffers()<CR>", "List open buffers")
