...
require("nvim-treesitter.configs").setup {
  ...
  incremental_selection = {
    enable = true,
    keymaps = {init_selection = "zi", node_incremental = "zi", scope_incremental = "zo", node_decremental = "zd"}
  },
...
Mapper.map_virtual("o", "<leader>rP", "", {}, "Navigation", "treesitter_swap_parameter_previous",
...
Mapper.map_virtual("o", "[m", "", {}, "Navigation", "treesitter_previous_function_start",
