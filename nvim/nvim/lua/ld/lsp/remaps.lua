...
function M.set_default(client, bufnr)
    ...
    if cap.definitionProvider then
        buf_set_keymap('n', 'gD',
                       ...
                       "lsp", 'lsp_preview_definition_saga',
                       'Preview definition')
        buf_set_keymap('n', 'gd', '<cmd>lua vim.lsp.buf.definition()<CR>',
                       'lsp', 'lsp_preview_definition', 'Preview definition')
    end
    ...
    if cap.documentSymbolProvider then
        ...
        buf_set_keymap('n', '<leader>lt',
                       ...
                       'lsp', 'lsp_workspace_type_definitions',
        ...
        buf_set_keymap('n', '<leader>bs',
                       ...
                       'lsp', 'telescope_lsp_document_symbols',
    ...
    buf_set_keymap('n', '<leader>leb',
                   ...
                   'lsp', 'lsp_show_buffer_diagnostics',
    ...
    buf_set_keymap('n', '<leader>lep',
                   '<cmd>lua vim.diagnostic.goto_prev()<CR>', 'lsp',
                   'lsp_previous_diagnostic', 'Previous diagnostic')
    buf_set_keymap('n', '<leader>len',
                   '<cmd>lua vim.diagnostic.goto_next()<CR>', 'lsp',
  ...
  buf_set_keymap('n', ']e', "<cmd>lua require'lspsaga.diagnostic'.lsp_jump_diagnostic_next()<CR>", 'lsp', 'lsp_next_diagnostic', 'Next diagnostic'); ]]
    ...
    if cap.documentFormattingProvider then
        buf_set_keymap('n', '<leader>lof',
                       '<cmd>lua vim.lsp.buf.formatting()<CR>', 'lsp',
                       'lsp_format', 'Format')
