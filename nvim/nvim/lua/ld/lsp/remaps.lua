...
function M.set_default(client, bufnr)
	...
	if cap.definitionProvider then
		buf_set_keymap("n", "gD", "<cmd>lua require('lspsaga.provider').preview_definition()<CR>", "Preview definition")
	...
	if cap.implementationProvider then
		buf_set_keymap("n", "<leader>li", "<cmd>lua vim.lsp.buf.implementation()<CR>", "Go to implementation")
	end
	...
	buf_set_keymap("n", "K", "<cmd>lua require('lspsaga.hover').render_hover_doc()<CR>", "Hover documentation")
	...
	if cap.codeActionProvider then
		...
		buf_set_keymap("v", "<leader>la", "<cmd>lua vim.lsp.buf.range_code_action()<CR>", "range code action")
	end
	...
	buf_set_keymap("n", "<leader>lep", "<cmd>lua vim.diagnostic.goto_prev()<CR>", "Previous diagnostic")
