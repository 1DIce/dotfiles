...
function M.set_default(client, bufnr)
  ...
  if cap.definitionProvider then
    buf_set_keymap("n", "gD",
        "<cmd>lua require('lspsaga.provider').preview_definition()<CR>", "lsp",
        "lsp_preview_definition_saga", "Preview definition")
    buf_set_keymap("n", "gT", "<cmd>lua vim.lsp.buf.type_definition()<CR>",
        "lsp", "lsp_go_to_type_definition", "Go to type definition")
  ...
  if cap.implementationProvider then
    buf_set_keymap("n", "<leader>li",
        "<cmd>lua vim.lsp.buf.implementation()<CR>", "lsp",
  ...
  buf_set_keymap("n", "<leader>lh",
      "<cmd>lua require('lspsaga.hover').render_hover_doc()<CR>", "lsp",
  ...
  buf_set_keymap("n", "<leader>lv",
      "<cmd>lua require('lspsaga.signaturehelp').signature_help()<CR>", "lsp",
  ...
  buf_set_keymap("n", "<leader>lew",
      "<cmd>lua require('telescope.builtin').diagnostics()<CR>", "lsp",
  ...
  buf_set_keymap("n", "<leader>leb",
      ...
      "lsp", "lsp_show_buffer_diagnostics", "Show buffer diagnostics")
  -- buf_set_keymap('n','<leader>fE', '<cmd>lua vim.diagnostic.show_line_diagnostics()<CR>', opts)
  buf_set_keymap("n", "<leader>lel",
      "<cmd>lua require'lspsaga.diagnostic'.show_line_diagnostics()<CR>", "lsp",
  ...
  if cap.renameProvider then
    ...
    buf_set_keymap("n", "<leader>lr",
        "<cmd>lua require('lspsaga.rename').rename()<CR>", "lsp", "lsp_rename",
        "Rename")
  ...
  buf_set_keymap("n", "<leader>lli", ":LspInfo()<CR>", "lsp", "lsp_info",
      "[DEBUG] LSP Info")
...
function M.set_typescript(client, bufnr)
  ...
  buf_set_keymap("n", "<leader>loi", ":TSLspOrganize<CR>", "lsp",
      "lsp_typescript_organize", "Organize imports")
  -- buf_set_keymap("n", "gr", ":TSLspRenameFile<CR>", 'lsp', 'lsp_', '')
  buf_set_keymap("n", "<leader>loa", ":TSLspImportAll<CR>", "lsp",
